...
> 基于 Web 移动端 + **EMQX Cloud** 高性能 MQTT 实时消息架构。

---

## ⚡ 极速开始（无需安装 Python）

- **最新正式版**：前往 [**GitHub Releases V1.0**](https://github.com/roronoia/xiaolaba/releases/tag/V1.0) 即可直接下载单文件可执行程序或免安装压缩包；
- **免安装直接运行**：单文件绿色版已内置全部依赖、音效与托盘图标，下载后双击即可直接运行！
